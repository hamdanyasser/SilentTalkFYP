    ...
    public partial class AddIdentitySupport : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { Guid.Parse("11111111-1111-1111-1111-111111111111"), "User", "USER", "Standard user role", DateTime.UtcNow, Guid.NewGuid().ToString() },
                    { Guid.Parse("22222222-2222-2222-2222-222222222222"), "Admin", "ADMIN", "Administrator role with full access", DateTime.UtcNow, Guid.NewGuid().ToString() },
                    { Guid.Parse("33333333-3333-3333-3333-333333333333"), "Moderator", "MODERATOR", "Content moderator role", DateTime.UtcNow, Guid.NewGuid().ToString() }
                });
        }
